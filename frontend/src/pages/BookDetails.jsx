...
export default function BookDetails() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Card-style layout with cover on left */}
      <div className="glass-card overflow-hidden max-w-4xl">
        <div className="flex flex-col md:flex-row gap-6 p-6">
          {/* Cover Image - Portrait style on left */}
          <div className="flex-shrink-0">
            <div className="w-32 h-48 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg flex items-center justify-center relative overflow-hidden shadow-lg">
          ...
          <div className="flex-1 space-y-4">
            ...
            {/* Book metadata - compact grid */}
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                <p className="text-gray-500 uppercase tracking-wider">Genre</p>
                <p className="text-gray-200 font-medium text-sm">{book.genre || 'N/A'}</p>
              </div>
              <div>
                <p className="text-gray-500 uppercase tracking-wider">Publisher</p>
                <p className="text-gray-200 font-medium text-sm">{book.publisher || 'N/A'}</p>
              </div>
              <div>
                <p className="text-gray-500 uppercase tracking-wider">Year</p>
                <p className="text-gray-200 font-medium text-sm">{book.year || 'N/A'}</p>
              </div>
              <div>
                <p className="text-gray-500 uppercase tracking-wider">Edition</p>
                <p className="text-gray-200 font-medium text-sm">{book.edition || 'N/A'}</p>
              </div>
            </div>
            ...
            <div className="space-y-2 border-t border-gray-700 pt-3">
              <div className="flex items-center justify-between">
                <h3 className="font-semibold text-gray-200 text-sm">Book Information</h3>
                {user?.role === 'ADMIN' && (
                  <button
                    onClick={() => setIsEditing(true)}
                    className="inline-flex items-center gap-1 px-2 py-1 rounded text-xs bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 transition-all"
                  >
      ...
      {/* Description and Details below the card */}
      <div className="space-y-6 max-w-4xl">
        {/* Description Section */}
        {!isEditing && (
          <div className="glass-card p-6 space-y-2 border-t border-gray-700 pt-4">
        ...
        {isPhysical && (
          <div className="glass-card p-6 space-y-3">
              <h2 className="text-lg font-semibold text-gray-200">Physical Copy Details</h2>            <div className="text-sm text-gray-400 space-y-2">
